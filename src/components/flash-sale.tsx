...
export default function FlashSale({ products, className = "" }: FlashSaleProps) {
  ...
  return (
    <section className={`mx-4 mt-5 ${className}`} aria-labelledby="flash-sale-heading">
      {/* Header Flash Sale */}
      <div className="rounded-t-2xl bg-gradient-to-r from-primary to-primary-dark p-3.5 flex items-center justify-between text-white shadow-sm">
        <div className="flex items-center gap-2">
          <div className="flex items-center justify-center w-7 h-7 rounded-lg bg-white/20 text-white shadow-inner">
            <svg
              width="16"
              height="16"
              viewBox="0 0 24 24"
          ...
          <div>
            ...
            <span className="text-[10px] text-black bg-white font-black px-2 py-0.5 rounded-full inline-block mt-0.5 shadow-xs">
              Giá sốc trong ngày
            </span>
          </div>
        </div>
