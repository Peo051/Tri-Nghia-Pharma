    ...
    <section className={`mx-4 mt-5 ${className}`} aria-labelledby="flash-sale-heading">
      ...
      <div className="relative overflow-hidden rounded-t-2xl bg-gradient-to-r from-[#0a4622] via-[#116936] to-[#22a458] p-3.5 flex items-center justify-between text-white shadow-sm">
        ...
        <div className="relative z-10 flex items-center gap-2">
          <div className="flex items-center justify-center w-7 h-7 rounded-lg bg-pink-500/20 text-pink-400 border border-pink-400/30 shadow-inner backdrop-blur-xs">
            <svg
              width="16"
              height="16"
              viewBox="0 0 24 24"
              fill="#f472b6"
              className="animate-bounce text-pink-400 drop-shadow-[0_1px_2px_rgba(244,114,182,0.5)]"
            >
