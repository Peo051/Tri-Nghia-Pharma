...
export default function NotFoundPage() {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-6 py-12 text-center">
      ...
      <h1 className="text-lg font-bold text-foreground">Không tìm thấy trang</h1>
      <p className="mt-1.5 max-w-[280px] text-sm leading-5 text-subtitle">
        Liên kết bạn mở không tồn tại hoặc đã được thay đổi.
      </p>
      <TransitionLink
        to="/"
        className="mt-6 inline-flex min-h-[42px] items-center justify-center rounded-pill bg-primary px-6 py-2 text-sm font-semibold text-white shadow-sm active:scale-95 transition-transform"
      >
        Về trang chủ
      </TransitionLink>
    </div>
